  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        quality: "border-orange-500/30 bg-orange-500/90 text-white backdrop-blur-sm hover:bg-orange-500 shadow-md font-medium text-[10px] px-2 py-0.5 cursor-help",
        // Variante para badges aprovados com fundo verde sólido
        approved: "border-green-600/20 bg-green-600 text-white hover:bg-green-700 shadow-md font-medium cursor-help",
        // Variante para badges adequados com fundo amarelo/laranja sólido
        adequate: "border-yellow-600/20 bg-yellow-600 text-white hover:bg-yellow-700 shadow-md font-medium cursor-help",
